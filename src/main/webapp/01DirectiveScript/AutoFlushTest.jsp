<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    buffer = "1kb" autoFlush = "false"%> <!-- 버퍼 설정 -->
<!--
...
/*
	...
	여기에 HTML태그들이 포함되어 있으므로 해당페이지의 용량은 1kb를 초과하게 되어
	실행시 에러가 발생한다. 
	해결방법은 buffer의 용량을 늘리거나, autoFlush를 true로 변경하면 된다. 
*/
...
/*
	...
	단, JSP가 웹브라우저에 내용을 출력할때 버퍼를 사용하는 것을 인지하고,
	이를 통해 에러페이지 처리나 포워드 등의 기능을 수행할 수 있게 된다.
*/
%>
</body>
</html>